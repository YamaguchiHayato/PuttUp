...
public class PrefabSpawner : MonoBehaviour
{
    ...
    void Update()
    {
        //if (Input.GetKeyDown(KeyCode.Space)) // スペースキーで生成
        //{
        //    SpawnNearSphere();
        //}
    ...
    //void SpawnNearSphere()
    //{
    //    if (spawnPrefab == null || sphereTransform == null)
    //    {
    //        Debug.LogWarning("PrefabかSphereが設定されていません。");
    //        return;
    //    }

    //    // スフィアの近くに生成（offsetを加える）
    //    Vector3 spawnPos = sphereTransform.position + offset;
    //    Quaternion spawnRot = Quaternion.Euler(spawnRotationEuler);
